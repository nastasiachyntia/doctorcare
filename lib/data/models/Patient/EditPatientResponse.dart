...
class Data {
  ...
  @override
  String toString() {
    return 'Data{id: $id, code: $code, name: $name, email: $email, image: $image, gender: $gender, birthDate: $birthDate, birthPlace: $birthPlace, isMarriage: $isMarriage, address: $address, bloodType: $bloodType, weight: $weight, height: $height, createdAt: $createdAt, updatedAt: $updatedAt}';
  }
}
